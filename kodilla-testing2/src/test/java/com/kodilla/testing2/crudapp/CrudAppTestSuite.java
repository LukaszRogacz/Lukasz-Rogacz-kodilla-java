...
public class CrudAppTestSuite {
    public static final String BASE_URL = "https://lukaszrogacz.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("lukaszrogacz");
        driverTrello.findElement(By.id("password")).sendKeys("Ytr;;p123");
